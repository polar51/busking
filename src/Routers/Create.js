...
const Create = () => {
  ...
  return(
    ...
    />
          ...
          <tr>
            <td colSpan="3" className={styles.textTd}>
          ...
          <tr>
            ...
            <td colSpan="1">
              <input value={inputTeamName} onChange={handleTeamName} placeholder='우리 공연팀의 이름을 입력해주세요!' className={styles.teamName} />
            </td>
          </tr>
        </tbody>
      </table>
      <button onClick={handleClick} className={styles.btn}>작성 완료!</button>
    </div>
  )
}
